...
#
# NOTE: This file is NOT used on
# the Chef managed servers, and exists
...
worker_processes ENV.fetch("UNICORN_COUNT").to_i
...
working_directory File.expand_path(ENV.fetch("UNICORN_APP_PATH"))
